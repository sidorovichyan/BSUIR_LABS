...
//функция считывающая слова состояния каналов     1-сост канала, 1-фл перегр конст. 00 -запом CE	,	111 режимы   ,   0 двоич-десятич
// 																					01 - чт/зап ст б
// 																					10 - чт/зап мл б
// 																					11 - чт/зап мл, затем ст б
void StateWords()
{
	char* bin_state;
	int iChannel;
	...
	for (iChannel = 0; iChannel < 3; iChannel++)
	{
		...
		case 0: 
		{
			outp(0x43, 0xE2); //заносим управляющее слово, 				11 1 0 0 0 1 0		
